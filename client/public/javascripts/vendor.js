...
(function(factory) {
        ...
        if (!keepData) {
          if (!selector || $.filter(selector, [this]).length) {
            $("*", this).add([this]).each(function() {
              try {
                return $(this).triggerHandler("remove");
              } catch (_error) {}
            });
          }
        }
  ...
  $.widget = function(name, base, prototype) {
    var basePrototype, fullName, namespace;
    ...
    $[namespace][name] = function(options, element) {
      if (arguments.length) {
        return this._createWidget(options, element);
      }
    };
    ...
    return $.widget.bridge(name, $[namespace][name]);
  };
    ...
    return $.fn[name] = function(options) {
      ...
      if (isMethodCall) {
        ...
        this.each(function() {
          ...
          instance = $.data(this, name);
          if (instance) {
            return instance.option(options || {})._init();
          } else {
  ...
  return $.Widget.prototype = {
    ...
    destroy: function() {
      ...
      return this.widget().unbind("." + this.widgetName).removeAttr("aria-disabled").removeClass(this.widgetBaseClass + "-disabled " + "ui-state-disabled");
    },
    widget: function() {
      return this.element;
    },
    ...
    _setOptions: function(options) {
      ...
      $.each(options, function(key, value) {
        return self._setOption(key, value);
      });
      return this;
    },
...
(function(factory) {
  "use strict";
  if (typeof define === "function" && define.amd) {
    return define(["jquery", "jquery.ui.widget"], factory);
  } else {
  ...
  return $.widget("blueimp.fileupload", {
    ...
    _chunkedUpload: function(options, testOnly) {
      var file, fs, jqXHR, mcs, n, pipe, slice, that, ub, upload;
      that = this;
      file = options.files[0];
      fs = file.size;
      ...
      upload = function(i) {
        ...
        return upload(i -= 1).pipe(function() {
          ...
          jqXHR = ($.ajax(o) || that._getXHRPromise(false, o.context)).done(function() {
            ...
            return options.uploadedBytes = o.uploadedBytes += o.chunkSize;
          });
          return jqXHR;
        });
      };
    ...
    _onSend: function(e, data) {
      var jqXHR, options, pipe, send, slot, that;
      that = this;
      jqXHR = void 0;
      slot = void 0;
      pipe = void 0;
    ...
    _initEventHandlers: function() {
      ...
      return this.options.fileInput.bind("change." + ns, {
        fileupload: this
      }, this._onChange);
    },
    _destroyEventHandlers: function() {
      ...
      return this.options.fileInput.unbind("change." + ns, this._onChange);
    },
    _setOption: function(key, value) {
      var refresh;
    ...
    _initSpecialOptions: function() {
      ...
      if (!(options.dropZone instanceof $)) {
        return options.dropZone = $(options.dropZone);
      }
    },
    _create: function() {
      var options;
          ...
          iframe = $("<iframe src=\"javascript:false;\" name=\"iframe-transport-" + (counter += 1) + "\"></iframe>").bind("load", function() {
            ...
            if (options.formData) {
              $.each(options.formData, function(index, field) {
                return $("<input type=\"hidden\"/>").prop("name", field.name).val(field.value).appendTo(form);
              });
            }
            if (options.fileInput && options.fileInput.length && options.type === "POST") {
              ...
              if (options.paramName) {
                options.fileInput.each(function(index) {
                  return $(this).prop("name", paramNames[index] || options.paramName);
                });
              }
            ...
            if (fileInputClones && fileInputClones.length) {
              return options.fileInput.each(function(index, input) {
                var clone;
                clone = $(fileInputClones[index]);
                $(input).prop("name", clone.prop("name"));
                return clone.replaceWith(input);
              });
            }
          });
          return form.append(iframe).appendTo(document.body);
        },
        abort: function() {
          if (iframe) {
...
jQuery.extend({
  ...
  backboneDelete: function(model) {
    this.model = model;
    if (confirm("Are you sure you want to delete this?")) {
      return this.model.destroy({
        success: function(model, res) {
          if (res.success) {
            return $(".index-row[data-id=" + model.id + "]").fadeOut(300, function() {
              return $(this).remove();
            });
          }
        }
      ...
      View.prototype.pass = function(attribute, selector) {
        ...
        return this.modelBind("change:" + attribute, function(model, value) {
          ...
          if ($el.is('input, textarea, select, button')) {
            return $el.val(value).addClass('changed').delay(_this.decay).queue(function(next) {
              $(this).removeClass('changed');
              return next();
            });
          } else {
            return $el.text(value).addClass('changed').delay(_this.decay).queue(function(next) {
              $(this).removeClass('changed');
              return next();
            });
          }
